<script lang="ts">
	...
	import type { Kind } from '$lib/models/kind';
	import type { Content as WatchableContent } from '$lib/models/content';
	import SendGridService from '$lib/services/api/sendgrid';
...
<div class="form">
	...
	<Snackbar surface$style="background-color: #951c13;" bind:this={snackbarError}>
